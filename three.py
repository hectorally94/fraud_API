...
def reportClasification(): 
    ...
    try:
        ...
        cursor.execute("SELECT id, enterprisename, chifreaffaire, datatopay FROM chiffre")
        ...
        cursor.execute("SELECT enterpriseid,  taxdeclared ,datepayed FROM declarationid")
